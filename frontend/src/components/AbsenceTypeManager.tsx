                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input
                                    ...
                                    autoFocus
                                    placeholder="z.B. Jahresurlaub, Krankheit..."
                                    required
                                />
                            </div>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-4 mb-4 mt-4">
                            <div className="flex items-center">
                                <input
                                    ...
                                    onChange={(e) => setFormData({ ...formData, is_vacation: e.target.checked })}
                                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                                />
                                <label htmlFor="is_vacation" className="ml-2 block text-sm font-medium text-gray-700">
                                    Zieht vom Urlaubsanspruch ab
                                </label>
                            </div>
                            <div className="flex items-center">
                                <input
                                    ...
                                    <tr key={type.id} className={!type.active ? "bg-gray-50" : ""}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex flex-col space-y-1">
                                                ...
                                                {type.is_vacation && (
                                                    <span className="px-2 py-0.5 inline-flex text-xs leading-4 rounded bg-purple-100 text-purple-800">
                                                        Zieht vom Urlaub ab
                                                    </span>
                                                )}
